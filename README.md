...
```groovy
dependencies {
    implementation 'org.jetbrains.kotlinx:kotlinx-coroutines-core:1.3.7-5a53535'
}
```
...
[`kotlinx-coroutines-core-common`](https://search.maven.org/artifact/org.jetbrains.kotlinx/kotlinx-coroutines-core-common/1.3.7-5a53535/jar)
...
```groovy
implementation 'org.jetbrains.kotlinx:kotlinx-coroutines-android:1.3.7-5a53535'
```
...
[`kotlinx-coroutines-core-js`](https://search.maven.org/artifact/org.jetbrains.kotlinx/kotlinx-coroutines-core-js/1.3.7-5a53535/jar)
(follow the link to get the dependency declaration snippet).
...
[`kotlinx-coroutines-core-native`](https://search.maven.org/artifact/org.jetbrains.kotlinx/kotlinx-coroutines-core-native/1.3.7-5a53535/jar)
(follow the link to get the dependency declaration snippet).
